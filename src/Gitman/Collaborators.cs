...
namespace gitman
{
    ...
    public class Collaborators : BaseBranchAction
    {
        ...
        public Collaborators(IGitHubClient client, string teamname, Permission permission = Permission.Push, List<string> only = null, List<string> not = null, bool exclusive = true) : this(teamname, permission, only, not, exclusive) {
            Client = client;
        }
